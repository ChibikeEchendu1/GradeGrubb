			...
			screen: TabNavigator(
						...
						screen: StackNavigator(
							{
								...
								ToolsEventnotTeacher: { screen: ToolsEventnotTeacher }
							},
							{ headerMode: "none" }
						)
					},
...

				{
					...
					tabBarComponent: props => {
						...
						if (x == 1) {
							return <FooterTab2 navigator={props} {...props} style={{ backgroundColor }}></FooterTab2>;
						} else {
							return <FooterTab3 navigator={props} {...props} style={{ backgroundColor }}></FooterTab3>;
						}
					}
				}
			)
		...
		Router3: {
			screen: TabNavigator(
...

				{
					...
					tabBarComponent: props => {
						return <FooterTab navigator={props}></FooterTab>;
					}
				}
			)
		},
