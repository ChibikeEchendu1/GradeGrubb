...
export default (state = INITIAL_STATE, action) => {
	...
	switch (action.type) {
		...
		case "FetchDone":
			return { ...state, pros: action.payload.profiles, redup: action.payload.redup, loading1: false };
		case "FetchDoneuuuu":
			return { ...state, loading1: false, gotp: true };
		case "FetchclaaDone":
		...
		case "EFetchEdit":
			return {
				...state,
				num: action.payload.info.Weight,
				num2: action.payload.info.worth,
				elesub2: action.payload.info.Name,
