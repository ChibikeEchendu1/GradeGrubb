...
import {FormInput,Card2,LogoHouse2,FormButton,Link,Spinner} from './index';
...
goback(){
  if (this.props.goat) {
    ...
    this.props.navigation.navigate('Code2',{Id});
}
}
...
onButtonPress(){
 ...
 goToHome=(nav = this.props.nav)=>{nav("Code2")}
...
export default connect(mapStateToProps,{emailChanged,passwordChanged,passwordChanged2,NameChanged,signupUser})(SignupForm) ;
