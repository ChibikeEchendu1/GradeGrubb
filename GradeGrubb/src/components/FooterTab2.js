	...
	render() {
		return (
			<SafeAreaView style={styles.viewStyle}>
				<TouchableOpacity style={styles.tab} onPress={() => this.navigate("Tsubject")}>
				...
				<TouchableOpacity style={styles.tab} onPress={() => this.navigate("one")}>
					<Icon name="user" color={this.isActive(1)} size={normalize(26)} style={{ marginTop: "10%", marginLeft: "25%" }} />
