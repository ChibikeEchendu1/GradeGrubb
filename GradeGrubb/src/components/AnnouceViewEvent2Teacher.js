...
class AnnouceViewEvent2Teacher extends Component {
  constructor(props){
  ...
  /* ComponentWillMount(){
   ...
   componentDidMount(){
    AsyncStorage.getItem("pro").then((value) => {
      ...
      let valll = this.props.item.name;
...
export default connect(mapStateToProps,{EventFetch})(AnnouceViewEvent2Teacher);
