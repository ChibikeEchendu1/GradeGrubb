...
<View style={{alignSelf:'center',alignItems:'center',marginLeft:10}}>
        ...
        <TouchableOpacity style={{ alignSelf:'center',alignItems:'center',marginLeft:'auto'}}  onPress={() =>
            props.nav.navigate("ToolsEventnotTeacher", {item:props.item})}> 
          <Icon name="comments" size={25} color={props.active} style={{ marginRight:30}}/>
